...
Для цього зробіть fork цього репозиторію (натисніть на кнопку [Fork](https://github.com/tatomyr/oop-2022-kn/fork)) і склонуйте його за допомогою такої команди:
